            ...
            <table className="w-full border-collapse text-[12.5px]">
              ...
              <tbody>
                {states.map((s) => {
                  ...
                  return (
                    <tr key={s.name} className="border-b border-border-subtle last:border-0 hover:bg-surface-hover">
        ...
        <Card>
          ...
          <CardContent className="p-0">
            <table className="w-full border-collapse text-[12.5px]">
              ...
              <tbody>
                {couriers.map((c) => (
                  <tr key={c.name} className="border-b border-border-subtle last:border-0 hover:bg-surface-hover">
